...
# Add this after authentication check in all 6th semester pages
st.set_page_config(page_title="6th Semester", page_icon="📘")
...
def main():
    load_dotenv()
    st.set_page_config(page_title="6th Semester", layout="centered", page_icon="📘")
